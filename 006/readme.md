...
-   ### Cuneiform and Hieroglyphs・楔形文字和象形文字
...
-   Anatolian Hieroglyphs・安纳托利亚象形文字
    -   Anatolian Hieroglyphs: U+14400–U+1467F・安纳托利亚象形文字
...
-   Meetei Mayek・米代文字
    ...
    >   Meetei Mayek 来自 mitei mayek /mit̪ɐj məjek/，依据《印地汉译音表》译作「米代默耶格」。也称「曼尼普尔文」。
-   Mro・姆鲁文字
...
### Indonesia and Oceania・印度尼西亚和大洋洲
